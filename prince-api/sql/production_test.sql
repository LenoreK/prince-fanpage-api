...
begin
    ...
    insert into album(album_id, album_name, release_year, riaa_certification, photo_url) values
        ...
        (4, "The Gold Experience", 1995, Null, "https://upload.wikimedia.org/wikipedia/en/6/6b/Prince_Gold.jpg");
	...
	insert into song(song_id, song_name, video_url, track, album_id) values
        ...
        (9, "Purple Rain", Null, 9, 2),
        (10, "The Most Beautiful Girl In the World", Null, 1, 4);
